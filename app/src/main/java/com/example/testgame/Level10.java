...
public class Level10 extends AppCompatActivity {
    ...
    Array10 array10 = new Array10(); // Создали новый объект из класса Array
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level10); //Установили текст название уровня

        //Текст описание уровня
        TextView text_levels_description = findViewById(R.id.text_levels_description);
        text_levels_description.setText(R.string.level_description10);
        ...
        dialog.setContentView(R.layout.previewdialog10); //Путь к макету
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(Level10.this, GameLevels.class);//Создали намерение для перехода
        ...
        imgleft.setImageResource(array10.images2[numLeft]);//Достаем картинку
        text_left.setText(array10.texts2[numLeft]);//Достаем из массива текст
        ...
        imgright.setImageResource(array10.images2[numRight]);
        text_right.setText(array10.texts2[numRight]);
