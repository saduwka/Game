...
public class Level9 extends AppCompatActivity {
    ...
    Array9 array9 = new Array9(); // Создали новый объект из класса Array
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level9); //Установили текст название уровня

        //Текст описание уровня
        TextView text_levels_description = findViewById(R.id.text_levels_description);
        text_levels_description.setText(R.string.level_description9);
        ...
        dialog.setContentView(R.layout.previewdialog9); //Путь к макету
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(Level9.this, GameLevels.class);//Создали намерение для перехода
        ...
        imgleft.setImageResource(array9.images2[numLeft]);//Достаем картинку
        text_left.setText(array9.texts2[numLeft]);//Достаем из массива текст
        ...
        imgright.setImageResource(array9.images2[numRight]);
        text_right.setText(array9.texts2[numRight]);
