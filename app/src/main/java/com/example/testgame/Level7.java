...
public class Level7 extends AppCompatActivity {
    ...
    Array7 array7 = new Array7(); // Создали новый объект из класса Array
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level7); //Установили текст название уровня

        //Текст описание уровня
        TextView text_levels_description = findViewById(R.id.text_levels_description);
        text_levels_description.setText(R.string.level_description7);
        ...
        dialog.setContentView(R.layout.previewdialog7); //Путь к макету
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(Level7.this, GameLevels.class);//Создали намерение для перехода
        ...
        imgleft.setImageResource(array7.images2[numLeft]);//Достаем картинку
        text_left.setText(array7.texts2[numLeft]);//Достаем из массива текст
        ...
        imgright.setImageResource(array7.images2[numRight]);
        text_right.setText(array7.texts2[numRight]);
